...
WHERE salary IN (salary < 40000, salary >100000);

-- 16번

SELECT first_name, gender, hire_date FROM employees
WHERE gender ='F' AND hire_date >= '1996-01-01';

-- 17번

SELECT emp_no, salary lary FROM salaries
WHERE salary BETWEEN 50000 AND 70000;

-- 18번

SELECT emp_no, from_date  FROM salaries
WHERE from_date BETWEEN '1990-01-01' AND '1995-01-01';
...
SELECT emp_no, dept_no FROM dept_emp
WHERE dept_no BETWEEN 'd003' AND 'd007';
